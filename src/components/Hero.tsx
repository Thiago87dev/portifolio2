  ...
  return (
    <div className="dark:bg-colorBg2Dark bg-colorBgLight flex justify-center w-full pt-16 md:pt-32 dark:text-colorTextDark text-colorTextLight min-h-screen">
      <div className="w-[1204px] flex items-center md:items-start flex-col md:flex-row justify-between px-2 lg:px-0">
        <div className="pt-24">
          <div>
            <p className="flex justify-center sm:justify-start italic text-xl">
              {t("iCreateWebsites")}
            </p>
          ...
          <div className="lg:ml-24 md:ml-12 ml-1 mt-14 lg:w-[580px] md:w-[480px] w-full border-l-2 border-solid md:pl-14 pl-2 py-4 border-colorHighlightsLight dark:border-colorHighlightsDark">
            <div>
              <h2 className={`text-3xl ${poppins.className}`}>
                {t("iam")} <span className="font-bold">{t("react")}</span>{" "}
                {t("and")} <span className="font-bold">{t("python")}</span>
              </h2>
