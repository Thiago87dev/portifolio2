        ...
        <div className="flex flex-col md:flex-row gap-10 md:gap-0 items-center mb-20">
          ...
          <div className="flex flex-col gap-8 w-[90%] sm:w-[80%] md:w-[65%] text-center md:text-left md:pl-20 text-lg">
            <p>
              ...
              <span className="font-bold">{t("troubleshooting")}</span>{" "}
              {t("arePillars")}{" "}
              <span className="font-bold">{t("dedicated")}</span> {t("iHaveAn")}{" "}
              <span className="font-bold">{t("easyTimeLearning")}</span>{" "}
              {t("newTechnologies")}{" "}
              <span className="font-bold">{t("organization")}</span> {t("and")}{" "}
              <span className="font-bold">{t("proactivity")}</span>{" "}
              {t("toAchieve")}
            </p>
            <p>
              {t("onThe")}{" "}
              <span className="font-bold">{t("technicalSide")}</span>,{" "}
              {t("iDevelop")}{" "}
              ...
              <span className="font-bold">Python, Django e MySQL</span>{" "}
              {t("onThe")} backend. {t("thisCombination")}
            </p>
            <p>{t("iAmAlways")}</p>
            <Link href={"/about"}>
