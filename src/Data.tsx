...
const iconsStyles = {
  html: {colorText:'#e34c25', colorBg: 'transparent'},
  css:{colorText:'#1575e3', colorBg: 'transparent' },
  javascript: {colorText:'#efda4e', colorBg: 'black' },
  typescript: {colorText:'#377cc8', colorBg: 'transparent'},
  react: {colorText:'#81e0ff', colorBg: 'transparent'},
  nextJs: {colorText:'#000000', colorBg: 'white', rounded: '100px' },
  tailwind: {colorText:'#3ebff8', colorBg: 'transparent' },
  python: {colorText:'#3c77a8', colorBg: 'transparent' },
  django: {colorText:'#113527', colorBg: 'transparent' },
  mysql: {colorText:'#e69208', colorBg: 'transparent'},
  git: {colorText:'#f05539', colorBg: 'transparent' },
  ...
  export const allProjects = [
    {
      ...
      icons: [
        ...
        { title: "Typescript", icon: <SiTypescript />, ...iconsStyles.typescript },
    ...
    },
    {
      ...
      icons: [
        { title: "React", icon: <SiReact /> , ...iconsStyles.react},
        { title: "Javascript", icon: <SiJavascript />, ...iconsStyles.javascript },
      ],
    },
    {
      title: "Bloggers",
